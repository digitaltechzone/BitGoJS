...
export const coins = CoinMap.fromCoins([
  ...
  tofcerc20('ofct1inch', 'Test 1Inch Token', 18, UnderlyingAsset['1INCH']),
  tofcerc20('ofctaudio', 'Test Audio', 18, UnderlyingAsset.AUDIO),
  tofcerc20('ofctaxs', 'Test Axie Infinity Shards', 18, UnderlyingAsset.AXS),
  tofcerc20('ofctcrv', 'Test Curve DAO Token', 18, UnderlyingAsset.CRV),
  tofcerc20('ofctcvx', 'Test Convex Finance', 18, UnderlyingAsset.CVX),
  tofcerc20('ofctdai', 'Test Dai', 18, UnderlyingAsset.DAI),
  tofcerc20('ofctdydx', 'Test dYdX', 18, UnderlyingAsset.DYDX),
  tofcerc20('ofctlrc', 'Test loopring', 18, UnderlyingAsset.LRC),
  tofcerc20('ofctmatic', 'Test Matic Token', 18, UnderlyingAsset.MATIC),
  tofcerc20('ofctomg', 'Test OmiseGO Token', 18, UnderlyingAsset.OMG),
  tofcerc20('ofctperp', 'Test Perpetual Protocol', 18, UnderlyingAsset.PERP),
  tofcerc20('ofctsand', 'Test Sand', 18, UnderlyingAsset.SAND),
  tofcerc20('ofctshib', 'Test Shiba Inu', 18, UnderlyingAsset.SHIB),
  tofcerc20('ofctsushi', 'Test SushiToken', 18, UnderlyingAsset.SUSHI),
